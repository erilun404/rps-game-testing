...
const SelectionPanel = ({ onSelect }: SelectionPanelProps) => {
  return (
    <div className="py-3 flex space-x-4">
      <button 
        className="shadow-xl w-24 bg-[#e7efc5] hover:bg-[#d3e3bd] text-gray-700 font-bold py-2 px-4 border border-slate-300 rounded flex flex-col items-center justify-center space-y-2" 
